  ...
  const industryExperiences = [
    {
      ...
      description:
        "Building and owning enterprise data pipelines for Bell's Network Ticket Service platform. Architected mission-critical ETL systems integrating four enterprise data sources into unified analytical reporting, with expanded scope into platform delivery and cross-domain investigations.",
      highlights: [
  ...
  const projects = [
    {
      ...
      description:
        '78-attribute MicroStrategy analytics platform integrating SmartPath, Maximo, IPACT, and LDAP. Built derived metrics, conditional formatting, and cross-filter interactivity deployed via structured migration pipeline.',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Portfolio of Sabbir Hossain, Data Engineer at Bell Canada with research background from Johns Hopkins and University of Toronto."
        />
      </Head>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="hero-image-wrapper fade-in" style={{ marginBottom: '2rem' }}>
              ...
              {/* The Stars Loop */}
              {[...Array(12)].map((_, i) => (
                <div key={i} className="star-particle" style={{ '--angle': `${i * 30}deg` }}>
                  ✦
                </div>
              ))}
            </div>
            ...
            <p
              ...
              style={{ maxWidth: '800px', margin: '0 auto 2rem auto', fontSize: '1.3rem', lineHeight: '1.7' }}
            >
              <span className="gradient-text">Data Engineer</span> at <span className="gradient-text">Bell Canada</span>{' '}
              building scalable analytics infrastructure.
              <br className="mobile-only" /> Former bioinformatics researcher at{' '}
              <span className="gradient-text">Johns Hopkins</span> and{' '}
              <span className="gradient-text">University of Toronto</span>. Harvard NCRC Plenary Speaker, back-to-back
              ASM ABRCMS award winner.
            </p>
            ...
            >
              ...
              <div
                className="hero-badge availability"
                style={{
                  fontSize: '1rem',
        ...
        <div className="container">
          ...
          <div className="about-content fade-in" style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              <h3 style={{ marginBottom: '1.5rem', color: 'var(--accent-secondary)', fontSize: '1.6rem' }}>
              ...
              {/* ========================================= */}
              <div
                className="executive-summary fade-in panel-surface"
                style={{
                  maxWidth: '950px',
              ...
              >
                ...
                >
                  ...
                  >
                    <strong style={{ color: 'var(--text-primary)' }}>Target Roles:</strong> Data Engineering • Data
              ...
              <div className="tldr-box" style={{ marginBottom: '2.5rem', textAlign: 'center' }}>
                ...
                <div className="tldr-content" style={{ fontSize: '1.1rem', lineHeight: '1.7' }}>
                  <ul style={{ display: 'inline-block', textAlign: 'left' }}>
                    ...
                    <li>
                      Built and maintain data infrastructure, dashboards, and business-critical pipelines used by
              ...
              >
                I&apos;m a <span className="gradient-text">Data Engineer</span> at{' '}
                <span className="gradient-text">Bell Canada</span> under the{' '}
              ...
              >
                My research at <span className="gradient-text">UofT</span> led me to cross-institutional work with{' '}
                <span className="gradient-text">Johns Hopkins</span>, and eventually to present at{' '}
                <span className="gradient-text">Harvard</span> — where I was selected as 1 of 12 plenary speakers from
                5,000+ applicants. I received oral and poster presentation awards at ABRCMS in back-to-back years. Along
                the way, I processed 750+ TB of multi-omics data and realized that
                <span className="gradient-text"> data platform engineering</span> is where I belong — building the
                infrastructure that makes insights possible.
              </p>
              <p
                style={{
                  margin: '0 auto 1.75rem auto',
            ...
            <div
              className="work-auth-container fade-in"
              style={{
                display: 'flex',
                justifyContent: 'center',
                gap: '2rem',
            ...
            <div className="interests-section fade-in" style={{ marginTop: '4rem', textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem' }}>
                <i className="fas fa-heart"></i> What I Love
              </h3>
              <div
      ...
      <section className="section" id="skills">
        <div className="container">
          <div className="section-header fade-in">
            <div className="section-label" style={{ fontSize: '1rem' }}>
              <i className="fas fa-cogs"></i> Technical Proficiency
            </div>
      ...
      <section className="section" id="experience_preview">
        <div className="container">
          <div className="section-header fade-in">
            ...
            <h2 className="section-title" style={{ fontSize: 'clamp(2rem, 5vw, 2.75rem)' }}>
              Experience
            </h2>
                    ...
                    {exp.highlights && exp.highlights.length > 0 && (
                      <ul style={{ marginBottom: '1.25rem' }}>
                        {exp.highlights.map((highlight, hIdx) => (
                          <li key={hIdx} style={{ marginBottom: '0.5rem' }}>
                            {highlight}
                          </li>
                        ))}
                      </ul>
      ...
      <section className="section" id="projects">
        <div className="container">
          <div className="section-header fade-in">
            <div className="section-label" style={{ fontSize: '1rem' }}>
              <i className="fas fa-laptop-code"></i> Featured Work
            </div>
        ...
        <div className="container">
          <div className="contact-cta fade-in">
            ...
            <p style={{ fontSize: '1.15rem' }}>
              Looking for my next opportunity in data platform engineering or data engineering.
            </p>
