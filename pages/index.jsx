...
const Home = () => {
  ...
  const aboutPara1 = "My journey began with a deep dive into the intricacies of Bioinformatics and Computer Science at the University of Toronto. This foundation sparked a passion for using software engineering not just to solve technical puzzles, but to build tools that empower research and discovery. I bridge the gap between scientific requirements and scalable, maintainable code, constantly exploring areas like efficient algorithms, cloud-native patterns, and reliable deployment strategies.";
  const aboutPara2 = "I believe in **continuous learning** and actively engage with new frameworks, best practices (like TDD and SOLID), and the broader tech community (e.g., through open-source contributions).";
  const seekingPara1 = "Leveraging my expertise across the SDLC and DevOps/SRE principles, I'm actively seeking opportunities in **Software Engineering, Data Engineering, DevOps/SRE, or Data Science** roles where I can contribute to challenging projects, particularly those involving cloud technologies, distributed systems, AI/ML applications, or bioinformatics.";
  const seekingPara2 = "I'm adept at cross-functional collaboration, thrive in remote environments, and I'm ready to bring my skills and continuous learning mindset to your team.";
