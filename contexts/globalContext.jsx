...
const EXPERIENCE_OVERVIEW = { // Renamed constant to follow JS convention (uppercase for constants)
  ...
  breakdown: {
    ...
    //  docker, jira, conf)
    dfp: { title: 'Google DoubleClick for Publishers', link: 'https://admanager.google.com/home/', experience_dates: [['2021-01', '2024-04']]},
    firebase: { title: 'Google Firebase', link: 'https://firebase.google.com/', experience_dates: [['2017-10', '2019-02']]},
    jquery: { title: 'JQuery', link: 'https://jquery.com/', experience_dates: [['2017-10', '2019-02']]},
    boot: { title: 'Bootstrap', link: 'https://getbootstrap.com/', experience_dates: [['2017-10', '2019-02'], ['2021-01', '2024-04']]},
    ...
    nosql: { title: 'MongoDB (NoSQL)', link: 'https://www.mongodb.com/nosql-explained', experience_dates: [['2017-10', '2019-02']]},
    mysql: { title: 'MySQL (and Workbench)', link: 'https://www.mysql.com/', experience_dates: [['2019-02', '2024-04']]},
    ...
    typescript: { title: 'TypeScript', link: 'https://www.typescriptlang.org/', experience_dates: [['2017-10', '2019-02']]},
    express: { title: 'ExpressJS', link: 'https://expressjs.com/', experience_dates: [['2017-10', '2024-04']]},
    aws: { title: 'Amazon Web Services (AWS)', link: 'https://aws.amazon.com/', experience_dates: [['2019-02', '2024-04']]}, // Corrected spelling
    css: { title: 'CSS/SCSS', link: 'https://en.wikipedia.org/wiki/CSS', experience_dates: [['2017-10', '2024-04']]},
    html: { title: 'HTML/HTML5', link: 'https://en.wikipedia.org/wiki/HTML5', experience_dates: [['2017-10', '2024-04']]},
    ...
    shell: { title: 'Bash / Shell', link: 'https://www.gnu.org/software/bash/', experience_dates: [['2017-10', '2024-04']]},
    linux: { title: 'Linux/Ubuntu', link: 'https://ubuntu.com/', experience_dates: [['2017-10', '2024-04']]},
    vscode: { title: 'Visual Studio Code', link: 'https://code.visualstudio.com/', experience_dates: [['2017-10', '2024-04']]},
    docker: { title: 'Docker', link: 'https://www.docker.com/', experience_dates: [['2019-02', '2024-04']]},
    jira: { title: 'Jira', link: 'https://www.atlassian.com/software/jira', experience_dates: [['2019-02', '2024-04']]},
    conf: { title: 'Confluence', link: 'https://www.atlassian.com/software/confluence', experience_dates: [['2019-02', '2024-04']]},
  }
};
